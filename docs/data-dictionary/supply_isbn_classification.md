...
| `title` | `varchar` | Material title text; source punctuation and casing retained | Deterministic representative catalog title for the ISBN. | Title supplied for the adopted course material. |
