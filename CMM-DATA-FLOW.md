...
flowchart LR
    ...
    class cmm_discipline_source,cmm_ia_source,external_pricing_source,brand_source,review25_source expected;
...
| 25 institution list | Institution subset/extracts, separate from production and 10% sample. |
