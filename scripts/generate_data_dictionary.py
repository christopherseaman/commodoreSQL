...
RELATION_METADATA: dict[str, RelationMetadata] = {
    ...
    "master_section": RelationMetadata("4_merged_records.sql", "One material-bearing period × section", ("master_material",), "Canonical per-term section release contract."),
    "master_course": RelationMetadata("4_merged_records.sql", "One material-bearing period × course", ("master_section",), "Provisional course rollup; price definitions approved, other definitions pending.", "Declared aggregate projection; no inherited base schema."),
    "sample_section_us_intro_fall2025": RelationMetadata("4_merged_records.sql", "Filtered master_section rows", ("master_section",), "Fall 2025 required intro/intermediate scope using the executable non-Canada/nonblank-state proxy.", "All columns inherited from master_section; filtered projection only."),
