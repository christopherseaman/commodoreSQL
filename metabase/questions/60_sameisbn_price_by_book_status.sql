...
WITH adopt AS (
  ...
  WHERE period_sortable = '2025-4'
    ...
    AND (has_book_status_required OR has_book_status_optional_recommended)
    AND NOT (has_book_status_required AND has_book_status_optional_recommended)
),
isbn_stats AS (
