...
-- display: table
-- description: All raw rental section/ISBN pairs, by physical/digital row-count shape. Distinct (physical, digital, total) raw vendor rental row-count shapes across all (section, isbn) pairs, with how many pairs share each shape. No catalog-derived inferred-required or canonical-Use filter is applied.
