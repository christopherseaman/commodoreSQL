...
-- display: table
-- description: Average required-material cost per section by course subject, with owned (buy-only) comparison and price coverage. Cost from master_section (section_cost).
