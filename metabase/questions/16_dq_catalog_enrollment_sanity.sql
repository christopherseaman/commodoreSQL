...
-- display: bar
-- description: Inferred-required 2024+ catalog rows with enrollment/seat anomalies. Catalog rows with anomalous enrollment vs seats_taken. Negative=bad data; sentinel 9999=uncapped courses; small/medium/large overage = real over-enrollment.
