...
| Models | `scripts/sql/models/*.sql` lexical | `master_institution`, `master_isbn`, `sample10pct_materials`. |
...
flowchart TD
  ...
  i2d --> e30["11 · 3_mailing_lists.sql"] --> e3b["12 · 3b_material_costs.sql"] --> e40["13 · 4_merged_records.sql"] --> m01["14 · models/master_institution.sql"] --> m02["15 · models/master_isbn.sql"] --> m03["16 · models/sample10pct_materials.sql"] --> x01
  i2d -. "NO_EDA" .-> x01
...
| `recent_periods` | Lookup view of newest 12 non-NULL terms from `course_catalog_20251215`. |
...
Solid arrows are dependencies; dotted arrows are projections/subsets/leaves. All 34 DBML relations are current and consumed. Geographic mailing is seven direct `current_mailing` export filters.
...
flowchart TD
  ...
  course_catalog_20251215 --> recent_periods --> current_mailing
